...
//     mm.add('(min-width: 951px) and (max-width: 2147px)', () => {
//       const newSizes = { wide: '20vw', narrow: '4.4vw' }
//       changeSizes(newSizes)
//     })

//     mm.add('(min-width: 569px) and (max-width: 950px)', () => {
...
//       const width = gsap.getProperty('.menu', 'width', 'vw')
//       const height = gsap.getProperty('.menu', 'height', 'vw')
//       const elements = menuContainer.current.querySelectorAll('.image-wrapper')
//       let wide
//       let narrow
//       elements.forEach(ele => {
//         if (ele.dataset.size === 'wide') {
//           wide = gsap.getProperty(ele, 'width', 'vw')
//         } else {
//           if (!narrow) narrow = gsap.getProperty(ele, 'width', 'vw')
//         }
//       })
//       const newSizes = { wide: wide, narrow: narrow }
//       changeSizes(newSizes)
//       changeContainerSize(newSizes, width, height)
//     })
...
//   function changeContainerSize(newSizes, width, height) {
//     gsap.set('.menu', {
//       width: width,
//       height: height,
//       marginLeft: newSizes.narrow
//     })
//   }
